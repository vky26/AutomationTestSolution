...
@CucumberOptions(tags = "@hotelBooking", glue = { "com.test.stepdefs" }, plugin = {"json:target/cucumber.json","com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"}, features = { "src/test/resources/features/" })
